...
import { ArrowLeft, BarChart3, Coins, PlusCircle, Trophy, UserRound } from "lucide-react";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const showBack = pathname !== "/matches";
            ...
            <div className="flex items-center gap-2">
              {showBack && (
                <button
                  ...
                  onClick={goBack}
                  aria-label="Go back"
                  className="focus-ring grid h-10 w-10 place-items-center rounded-lg border border-[#6FB4EB] bg-[#094586] text-[#D0FEF5]"
                >
                  <ArrowLeft size={20} />
                </button>
              )}
